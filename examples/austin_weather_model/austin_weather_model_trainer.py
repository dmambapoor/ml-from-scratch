...
from ml_from_scratch.MLP import MLP  # type: ignore
...
model = MLP()
model.fit(np.atleast_2d(x_train), np.atleast_2d(y_train), batch_size=100, max_iterations=2000, tolerance=1e-3, failed_iterations_threshold=3, verbose=True)
